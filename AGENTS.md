...
| 2026-07-11 | Upgrade subagent model registry alignment                      | `.codex/agents/*.toml`                                              | Replace legacy `gpt-5.5` assignments with current role-based `gpt-5.6` models and reasoning efforts.                                                       |
