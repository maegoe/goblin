...
local function buildCamp()
	...
	if RunService:IsStudio() then
		local resetProgressionButton = createImageButton(root, "ResetProgression", campAssets.camp_button_secondary_default_512x128, UDim2.fromScale(0.72, 0.08), UDim2.fromScale(0.21, 0.055), "Reset QA", 14)
